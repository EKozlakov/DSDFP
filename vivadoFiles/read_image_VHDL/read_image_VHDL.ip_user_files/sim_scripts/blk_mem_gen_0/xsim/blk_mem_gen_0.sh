...
#
# Generated by Vivado on Wed Apr 14 22:23:48 -0400 2021
...
xv_boost_lib_path=D:/XilinxDONOTPUSH/Vivado/2020.2/tps/boost_1_64_0
xvhdl_opts="--relax"
...
{
  file="xsim.ini"
  lib_map_path="D:/XilinxDONOTPUSH/Vivado/2020.2/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
